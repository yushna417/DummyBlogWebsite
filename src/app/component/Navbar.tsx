...
const [allPosts, setAllPosts] = useState<Ipost[]>([]);
  ...
  return (   
    ...
    <nav className="bg-gray-200 border-b-gray-400 border dark:border-gray-900 dark:bg-gray-900 lg:px-10 px-0 fixed min-w-screen z-10 ">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4 sticky">
      <div  className="flex items-center space-x-1 rtl:space-x-reverse">
          <Image src="/logo.png" className="" alt='Logo' width={32} height={32} />
          <span className="self-center lg:text-2xl text-xl lg:font-semibold font-medium whitespace-nowrap dark:text-white">rcodify</span>
      </div>
      ...
      <form className="flex flex-col items-center w-1/2 ">   
        <div className='flex w-full justify-end'>
          ...
          <button onClick={handleSearch} type="submit" className="p-2.5 ms-3 text-sm font-semibold group text-white bg-blue-700 rounded-lg border border-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 flex gap-x-2 ">
        ...
        <ul className="absolute mt-12 dark:bg-gray-800 bg-gray-300 shadow-md rounded-md w-1/2 border max-h-48 overflow-y-auto">
